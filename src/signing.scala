...
case class PlainSigningConfig(
    override val keystore: File,
...
) extends ApkSigningConfig

case class PromptStorepassSigningConfig(
    override val keystore: File,
    override val alias: String,
    override val storeType: String = "jks",
    override val v1: Boolean = true,
...
case class PromptPasswordsSigningConfig(
    override val keystore: File,
    override val alias: String,
    override val storeType: String = "jks",
    override val v1: Boolean = true,
  ...
  override lazy val keyPass =
    Option(
      console
        .readPassword("Enter password for key '%s': " format alias) mkString
    )
}

case class DebugSigningConfig(
    override val keystore: File = file(
