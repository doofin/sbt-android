...
TaskKey[Unit]("verify-res-values") := {
  ...
  if ("test_resource" != name)
    sys.error(s"wrong name value: [$name] ${name.getClass}")
...
TaskKey[Unit]("check-global-aar") := Def.task {
  val path =
    Path.userHome / ".android/sbt/exploded-aars/com.google.android.gms-play-services-4.3.23/com.google.android.gms-play-services-4.3.23.jar"
